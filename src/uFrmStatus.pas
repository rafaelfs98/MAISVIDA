...
begin
 with lvPedido.Items.Add do
   begin
     ...
     TListItemText(Objects.FindDrawable('Text2')).Text := 'Preço R$ '+formatFloat('0.00',valor);
                  ...
                  status  := 'EXPIRADO';
                   ...
                   begin
                    ...
                    begin
                     ...
                     lbPagamento.Text := 'Cartão'  + #13 + 'R$'+total;
                   ...
                   begin
                    ...
                    if status = 'SEPARAÇÃO' then
                    begin
                     lnRealizado.Visible := True;
                     lytEmSeparacao.visible := True;
                     lnEmseparação.Visible := False;
...
begin
        ...
        mensagem := 'Olá Me chamo '+'*'+nome +' '+sobrenome+'*'+' estou falando em Relação ao Pedido de N° '+'*'+pedido +'*';
